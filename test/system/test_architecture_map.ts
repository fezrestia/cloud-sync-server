...
const TARGET_URL_EDIT = "http://localhost:8080/svg_diagram/edit.html";
const TARGET_URL_VIEW = "http://localhost:8080/svg_diagram/view.html";
...
describe("Test Architecture Map Web SPA Interaction", () => {
  ...
  beforeEach( async () => {
    ...
    await driver.get(TARGET_URL_EDIT);
  ...
  it("Get View Root", async () => {
    await driver.get(TARGET_URL_VIEW);
    let svg = await driver.findElement(By.id("svg_root"));
    let html = await driver.findElement(By.id("html_root"));
      ...
      [Def.KEY_ARCHITECTURE_MAP]: [
        {
          ...
          [Def.KEY_DIMENS]: {
            ...
            [Def.KEY_LABEL_HORIZONTAL_ALIGN]: "center",
            [Def.KEY_LABEL_ROT_DEG]: 0,
            [Def.KEY_LABEL_VERTICAL_ALIGN]: "middle",
            [Def.KEY_Z_ORDER]: 1,
          },
          [Def.KEY_EDGE_LINE_STYLE]: "normal",
